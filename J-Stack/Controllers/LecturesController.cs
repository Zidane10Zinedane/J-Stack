...
namespace J_Stack.Controllers
{
    public class LecturesController : Controller
    {
        ...
        private LectureLogic db = new LectureLogic();
        // GET: Lectures
        public ActionResult getDegreeForLecture(int id)
        {
            return View(cb.Degrees.Where(x => x.D_Id == id).ToList());
        }
        public ActionResult Index()
        {
            var lectures = cb.Lectures.Include(l => l.degrees);
        ...
        public ActionResult Create(Lecture model)
        {
            ...
            {
                model.FullName = model.geFullName(model.Forenames,model.Surname);
                model.FirstName = model.getFirstName(model.Forenames);
                db.Add(model);
